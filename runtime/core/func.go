...
// don't change the following marker
// they are generated by xgo
// ==start xgo func==
type Kind = types.Kind

const (
	Kind_Func   = types.Kind_Func
	Kind_Var    = types.Kind_Var
	Kind_VarPtr = types.Kind_VarPtr
	Kind_Const  = types.Kind_Const
)
