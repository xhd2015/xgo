...
func insertTrapPoints() {
	...
	forEachFunc(func(fn *ir.Func) bool {
		...
		// current problem:
		// # reflect
		// ../../../../.xgo/go-instrument/go1.20.1_Us_xh_in_go_5fbc0992/go1.20.1/src/reflect/value.go:877:6: internal compiler error: 'methodReceiver': value .autotmp_15 (nil) incorrectly live at entry

		// 		# time
		// ../../../../.xgo/go-instrument/go1.20.1_Us_xh_in_go_5fbc0992/go1.20.1/src/time/format_rfc3339.go:82:6: internal compiler error: dictionary variable not captured by value
