...
func PatchByName(pkgPath string, funcName string, replacer interface{}) func() {
	if !legacy.V1_0_0 {
		panic("PatchByName is deprecated and no longer supported, use Patch instead")
	}
	if replacer == nil {
		panic("replacer cannot be nil")
	}
	...
	return mockLegacy(recvPtr, funcInfo, funcPC, trappingPC, buildInterceptorFromPatch(recvPtr, replacer))
}

// Deprecated: use Patch instead.
func PatchMethodByName(instance interface{}, method string, replacer interface{}) func() {
	if !legacy.V1_0_0 {
		panic("PatchMethodByName is deprecated and no longer supported, use Patch instead")
	}
	if replacer == nil {
		panic("replacer cannot be nil")
	}
...
func buildInterceptorFromPatch(recvPtr interface{}, replacer interface{}) func(ctx context.Context, fn *core.FuncInfo, args, results core.Object) error {
	...
	return func(ctx context.Context, fn *core.FuncInfo, args, results core.Object) error {
		...
		if fn.RecvType != "" {
			var isInstance bool
			if recvPtr != nil {
				if fn.Generic && trap_legacy.GenericImplIsClosure && args.NumField() == nIn {
					// not an instance
				} else {
					isInstance = true
				}
